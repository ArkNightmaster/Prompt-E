...
class Learner(BaseLearner):
    ...
    def _train(self, train_loader, val_loader, test_loader):
        ...
        if self._cur_task > 0:
            # Initialize prompt when shared prompt pool exists, default not to do this
        ...
        for i, (_, inputs, targets, names) in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                if i % 10 == 0 and self.args['rt_weight']:
                    prompt_weights = tensor2numpy(self.network1(inputs, task_id=self._cur_task)["prompt_weight"])
